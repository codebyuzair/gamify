...
List<Game> games2 = [
  ...
  Game(
    ...
    GameImage("https://www.videogameschronicle.com/files/2023/11/T2R_Blog_ComingSoon.jpg", ""),
    "",
    "Naughty Dog",
  ),
  Game(
    ...
    GameImage(
        "https://images.bauerhosting.com/legacy/empire-images/reviews_games/5c9a0800133d503e3a482f6c/sekiro%20header.jpg?ar=16%3A9&fit=crop&crop=top&auto=format&w=1440&q=80",
        ""),
    "",
    "From Software",
  ),
...
List<Game> featuredGames = [
  ...
  Game(
    ...
    GameImage(
        "https://www.gamepat.net/wp-content/uploads/2021/10/Dragon-Ball-Z-Kakarot.jpg",
        ""),
    "",
    "CyberConnect2",
  ),
